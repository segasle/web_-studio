    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-6">
            ...
            <div class="block_text">
                <p class="text h4">Мы - команда профессиональных WEB-разработчиков, создаем новое, улучшаем старое.</p>
            </div>
        </div>
        <div class="col-12 col-sm-12 col-md-6">
            <form method="post" enctype="multipart/form-data" class="ask-form">
                ...
                <div class="form-row">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <input type="email" class="form-control form-control-lg email" placeholder="sega@ya.ru"
                               name="email"
