<form method="post" enctype="multipart/form-data" class="ask-form">
    ...
    <div class="form-row">
        <div class="col-12 col-md-4 mb-3">
            ...
            <input type="text" class="form-control-lg form-control name animation-bs" id="validationServer01"
                   placeholder="Имя" name="name">
            <div id="ansName"></div>
        </div>
        <div class="col-12 col-md-4 mb-3">
            <label for="validationServer02" class="col-form-label-lg">Телефон</label>
            <input type="text" class="form-control phone-number form-control-lg animation-bs"
    ...
    if ($page === $main or empty($page)) { ?>
        <div class="form-group">
            ...
            <input type="text" class="form-control form-control-lg topic animation-bs" id="exampleInputPassword1"
                   name="topic" placeholder="Тема">
        </div>
    <?php } ?>
    <div class="form-group">
        <label for="exampleFormControlTextarea1" class="col-form-label-lg">Сообщение</label>
        <textarea class="form-control message form-control-lg animation-bs" id="exampleFormControlTextarea1" name="message"
                  rows="3"></textarea>
    </div>
